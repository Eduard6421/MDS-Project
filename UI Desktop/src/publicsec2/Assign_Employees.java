 ...
 * @author user
 */
public class Assign_Employees extends javax.swing.JFrame {

    /**
     * Creates new form Assign_Employees
     */
    static Assign_Employees Fereastra;

    public Assign_Employees() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("PublicSEC - Assign_Employees");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Assign_Employees.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Assign_Employees().setVisible(true);

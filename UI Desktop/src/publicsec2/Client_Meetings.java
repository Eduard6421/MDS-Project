 ...
 * @author GABY
 */
public class Client_Meetings extends javax.swing.JFrame {

    /**
     * Creates new form Client_Meetings
     */
    static Client_Meetings Fereastra;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Client_Meetings.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Client_Meetings().setVisible(true);
            }
        });
    }

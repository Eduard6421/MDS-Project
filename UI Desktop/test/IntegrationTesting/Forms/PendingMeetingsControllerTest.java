 ...
 * @author Eduard
 */
public class PendingMeetingsControllerTest {

    public PendingMeetingsControllerTest() {
    }
    ...
    @Test
    public void testPendingMeetingsController1() {
        GlobalData.setCompanyName("Firma1");
        GlobalData.setUserId(1);
        PendingMeetingsController controller = new PendingMeetingsController("View all meetings");
    ...
    @Test
    public void testPendingMeetingsController2() {
    ...
    @Test
    public void testPendingMeetingsController3() {
    ...
    @Test
    public void testPendingMeetingsController4() {

        GlobalData.setCompanyName("Firma1");
        GlobalData.setUserId(1);
        PendingMeetingsController controller = new PendingMeetingsController("View closed meetings");
    ...
    @Test
    public void testPendingMeetingsController5() {
